...
import ShangPage from '../ShangPage/shang'

const { Header, Content, Footer, Sider } = Layout;


export default class ShangcPage extends React.Component{
    render(){
        return(
            <Layout>
            <Sider
      ...
      <Col span={6}>
       ...
       <Col span={2}></Col>
              ...
              <Content style={{ margin: '24px 16px 0', overflow: 'initial' }}>
                ...
                <div>
    <Row>
      <Col span={11}><ShangPage></ShangPage></Col>
      <Col span={13 }></Col>
  ...
  <Row>
      ...
      <Col span={6}><Link to="/shanc"><Icon type="shopping-cart" />商城</Link></Col>
